...
namespace Tasky_AIModel
{
    ...
    {
        /// <summary>
        /// model input class for UrgencyMLModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for UrgencyMLModel.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"urgencia")]
            public uint Urgencia { get; set; }

            [ColumnName(@"asunto")]
            public float[] Asunto { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("UrgencyMLModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("urgencia");
            if (labelColumn == null)
            {
                throw new Exception("urgencia column not found. Make sure the name searched for matches the name in the schema.");
            }
