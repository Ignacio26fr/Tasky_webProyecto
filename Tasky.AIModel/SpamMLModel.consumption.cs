...
{
    public partial class SpamMLModel
    {
        /// <summary>
        /// model input class for SpamMLModel.
        /// </summary>
        ...
        /// <summary>
        /// model output class for SpamMLModel.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("SpamMLModel.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("spam");
            if (labelColumn == null)
            {
                throw new Exception("spam column not found. Make sure the name searched for matches the name in the schema.");
            }
